...
import com.redhat.tasksyncer.dao.accessors.*;
...
public class ProjectAccessorCreatingRepositoryTests {
    ...
    public void setup() throws NoSuchFieldException {
        ...
        projectAccessorUnderTest = new ProjectAccessorImpl(issueRepository, projectRepository, repositoryRepository,
                boardAccessor, repositoryAccessors);
