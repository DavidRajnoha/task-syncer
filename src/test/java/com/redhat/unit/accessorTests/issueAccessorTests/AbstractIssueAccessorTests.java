package com.redhat.unit.accessorTests.issueAccessorTests;
...
public class AbstractIssueAccessorTests {
    ...
    public void setup() throws NoSuchFieldException {
        ...
        issueAccessor = new AbstractIssueAccessor(issueRepository);
        Mockito.doAnswer(returnsFirstArg()).when(issueRepository).save(any());
    ...
    public void whenExistingIssueIsUpdated_thenChangedFieldsAreUpdated(){
        ...
        AbstractIssue foundIssue = issueAccessor.update(updatedIssue);
    ...
    public void whenNewIssueIsUpdated_thenNewIssueIsReturned(){
        ...
        AbstractIssue foundIssue = issueAccessor.update(newIssue);
    ...
    public void whenExistingIssueWithExisitingSubIssueIsUpdated_thenChangedFieldsAreUpdated(){
        ...
        AbstractIssue foundIssue = issueAccessor.update(parentUpdatedIssue);
    ...
    public void updateIssueWithManySubtasksWhileProvideingJustOne(){
        ...
        AbstractIssue foundIssue = issueAccessor.update(updatedParentIssue);
    ...
    public void whenUpdatingSubtaskWrappedInEmptyIssue_thenIsTheSubtaskUpdatedAndTheIssueInfoIsRetained(){
        ...
        AbstractIssue foundIssue = issueAccessor.update(containerIssue);
    ...
    public void whenUpdatingNewIssueWithMoreThenOneSubtasks_thenNoConcurrentModificationIsThrown(){
        ...
        AbstractIssue foundIssue = issueAccessor.update(parentIssueWithManySubtasks);
